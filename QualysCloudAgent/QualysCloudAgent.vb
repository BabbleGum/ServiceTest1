...
Public Class QualysCloudAgent
    ...
    Sub Log(p_Command As String, p_Systems As String)
        Try
            Using sw As New StreamWriter(Path.Combine(v_Path, "Service.log"), True, Text.Encoding.UTF8)
    ...
    Protected Overrides Sub OnStart(ByVal args() As String)
        ...
        Try
            ...
            v_FileWatcher = New FileSystemWatcher(v_Path) With {
                ...
                Do
                    ...
                    If line IsNot Nothing Then
                        ...
                        If line.Length > 0 Then
                            ...
                            Proz.StartInfo.StandardErrorEncoding = Text.Encoding.UTF8
                            Proz.StartInfo.RedirectStandardError = True
                            Proz.StartInfo.CreateNoWindow = True
